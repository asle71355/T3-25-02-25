        ...
        static void Main(string[] args)
        {
            ...
            switch (tal)
            {
                case 1:
                    ...
                    Console.WriteLine("rumfanget af din kube: " + kubeVolume(h, b, i));
                    break;
                case 2:
                    Console.Write("indtast højde: ");
                    ...
                    Console.WriteLine("rumfanget af din cylinder: " + cylidnerVolume(højde, radius));
                    break;
            }
        }
        
        static float kubeVolume(float h, float b, float l)
        {
            return l * b* h;
        }
        
        static float cylidnerVolume(float h, float radius)
        {
